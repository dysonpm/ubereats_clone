...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/phoneinputScreen',
          builder: (context, params) => PhoneinputScreenWidget(),
        ),
        FFRoute(
          name: 'passwordinputScreen',
          path: '/passwordinputScreen',
          builder: (context, params) => PasswordinputScreenWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'homescreenDelivery',
          path: '/homescreenDelivery',
          builder: (context, params) => HomescreenDeliveryWidget(),
        )
